			...
			<div className="py-5 bg-theme-light">
				<div className="container">
					...
					<p data-aos="fade-up" style={{ fontWeight: 400 }} className="font-20">
						<b>BESDA AF-TESS</b> (Better Education Service Delivery For All
						Additional Finance Transforming Education Systems at States Level)
						program was initiated in response to the need for educational reform
						and improvement in Nigeria. The program focuses on improving teacher
						quality, enhancing curriculum and assessment systems, strengthening
						school infrastructure, and promoting community engagement.
					</p>
				</div>
			</div>
		</section>
