	...
	return (
		<main className="container pb-100">
			...
			{video_gallery.length > 0 && (
				<BlogSearch posts={video_gallery} title={'Videos'} queryWord={query} />
			)}
			{image_gallery.length > 0 && (
				<BlogSearch posts={image_gallery} title={'Photos'} queryWord={query} />
			)}

			<div style={{ marginTop: 20 }} className="col-12" bis_skin_checked="1">
