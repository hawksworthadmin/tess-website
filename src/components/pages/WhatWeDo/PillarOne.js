					...
					<div className="col-lg-6">
						<div className="local-councils-content pr-15">
							...
							<p style={{ fontSize: '20px' }}>
								...
								students to transition to junior secondary education in
								communities without junior secondary schools. Additionally, our
								program incentivizes the development of a mechanism in each
								state to ensure the equitable distribution of resources beyond
								our intervention.
							</p>
						</div>
					</div>
